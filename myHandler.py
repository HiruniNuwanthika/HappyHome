...
class myHandler(DatagramProtocol):
    ...
    def sendDataSenze(self,sensors,data,recipient):
        ...
        for sensor in sensors:
            ...
            #If humidity is requested
            elif "humidity" == sensor:
                response ='%s #humidity %s' %(response,driver.readHumidity())

            #If waterLevel is requested
            elif "waterlevel" == sensor:
                response ='%s #waterlevel %s' %(response,driver.readWLevel())
